...
export default class Dropdown extends Component {
    ...
    _renderButton() {
        const {disabled, accessible, children,ArrowImages,dropdownHeight,buttonTextStyle, type,showArrow,arrowBackgroundColor,dropDownImage,placeholderText,dropdownStyle,shadowStyle,arrowStyle,} = this.props;
        const {buttonText} = this.state;
            return (
                ...
                >
                    <View style={[styles.button,shadowStyle,dropdownStyle,{overflow:'hidden',marginTop: this.props.marginTop || 12 }]}>
                    ...
                    { showArrow === false ?
                            ...
                            :
                        <View style={{height:'100%',width:'12%',backgroundColor:arrowBackgroundColor,alignItems: 'center',justifyContent:'center',borderRadius:3}}>
                            <Image style={[styles.loginDropdownImages,arrowStyle,{tintColor: arrowBackgroundColor ? '#ffffff' : colors.app_color}]} source = {dropDownImage  ?  dropDownImage : images.dropdown }    />
                        </View>
                    }
                </View>
                </TouchableOpacity>
                ...
                >
                    ...
                    >
                        <View style={styles.modal}>
                            <View elevation={10} style={[styles.dropdown, dropdownOptionsStyle, frameStyle,{height: '22%'}]}>
